...
import dag.lydbok.model.nearestAfter
import dag.lydbok.model.nearestBefore
...
class PointsBuilderTest {
    ...
    fun test() {
        ...
        assertThat(points.nearestBefore(100_000_000), `is`(points.last()))
        ...
        assertThat(points.nearestAfter(100_000_000), IsNull.nullValue())
    }
