...
class Track(val trackFile: File, val durationInSecs: Int) : Comparable<Track> {
    val title = trackFile.name.removeSuffix(".m4a").removeSuffix(".mp3")
    ...
    override fun toString(): String {
        return "Track($trackFile/$durationInSecs)"
    }
